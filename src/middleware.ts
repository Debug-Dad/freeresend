  ...
  if (!token) {
    ...
    return new NextResponse(
      `<!DOCTYPE html><html><body style="font-family:system-ui;padding:40px;max-width:500px;margin:0 auto">
        ...
        <p style="margin-top:24px"><a href="https://admin.debugdad.com" style="background:#3b82f6;color:white;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block">Log in to Admin &rarr;</a></p>
      </body></html>`,
